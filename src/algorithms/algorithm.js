...
export const bfs = (edges, startNodeId) => {
  ...
  while (!bfsQueue.isEmpty()) {
    ...
    if (!visitedSet.has(nodeId)) {
      visitedEdges.push(Object.assign(Object.assign({}, mockEdge),
        { from: lastVisitedEdge.from, to: lastVisitedEdge.to }));
      const neighbours = findNeighbours(nodeId, newEdges, visitedSet);
      neighbours === null || neighbours === void 0 ? void 0 :
        neighbours.forEach((id) => {
          bfsQueue.push(Object.assign(Object.assign({}, mockEdge), { from: nodeId.toString(), to: id.toString() }));
        });
    }
  }
  return visitedEdges;
...
export const dfs = (edges, startNodeId) => {
  ...
  while (!dfsStack.isEmpty()) {
    ...
    if (!visitedSet.has(parseInt(lastVisitedEdge.to))) {
      visitedEdges.push(Object.assign(Object.assign({}, mockEdge), { from: lastVisitedEdge.from, to: lastVisitedEdge.to }));
      const neighbours = findNeighbours(nodeId, newEdges, visitedSet);
      neighbours === null || neighbours === void 0 ? void 0 : neighbours.forEach((id) => {
        dfsStack.push(Object.assign(Object.assign({}, mockEdge), { from: nodeId.toString(), to: id.toString() }));
      });
    }
  }
  return visitedEdges;
...
const backtrack = (prev, startNodeId, endNodeId) => {
  ...
  for (let i = 0; i < visitedOrder.length - 1; i++) {
    visitedEdges.push(Object.assign(Object.assign({}, mockEdge), { from: visitedOrder[i].toString(), to: visitedOrder[i + 1].toString() }));
  }
  return visitedEdges;
};
...
const getUnvisitedNeighbours = (currentEdge, edges, distance, unvisitedSet, prev) => {
  var _a;
  let currentNodeId = parseInt(currentEdge.to);
  if (edges.get(currentNodeId)) {
    (_a = edges.get(currentNodeId)) === null || _a === void 0 ? void 0 : _a.forEach((edge) => {
      if (unvisitedSet.has(parseInt(edge.to))) {
        let shouldCompare = true;
        let newDistance = distance.get(currentEdge) + edge.weight;
        distance.forEach((value, d_edge) => {
          if (edge.to === d_edge.to &&
            value !== Infinity &&
            value <= newDistance) {
            shouldCompare = false;
          }
...
const findNeighbours = (nodeId, edges, visitedSet) => {
  ...
  if (!visitedSet.has(nodeId)) {
    ...
    return (_a = edges.get(nodeId)) === null || _a === void 0 ? void 0 : _a.map((edge) => {
...
export const minspantreeprims = (edges, nodes, startNodeId) => {
  ...
  newEdges.forEach((edges) => {
    isGraphNotEligible =
      isGraphNotEligible ||
      (edges === null || edges === void 0 ? void 0 : edges.some((edge) => edge.type === "directed"));
  });
  ...
  for (let i = 0; i < nodes.length - 1; i++) {
    ...
    (_a = newEdges.get(minimumNodeId)) === null || _a === void 0 ? void 0 : _a.forEach((edge) => {
...
const getVisitedEdges = (prev, visitedEdges, nodes, startNodeId) => {
  ...
  for (let i = 0; i < nodes.length; i++) {
    if (prev.get(nodes[i].id) !== undefined) {
      visitedEdges.push(Object.assign(Object.assign({}, mockEdge), { from: (_a = prev.get(nodes[i].id)) === null || _a === void 0 ? void 0 : _a.toString(), to: nodes[i].id.toString() }));
    }
  }
  return visitedEdges;
};
