...
const Board = () => {
  ...
  const activateOption = (option) => {
    const updatedOptions = mapValues(options, (_value, key) => key === option ? true : false);
  ...
  const handleAlgoOptions = (_event, option) => {
    ...
    setSelectedEdge({ key: "select", text: "Select Edge" });
    if ((option === null || option === void 0 ? void 0 : option.key) === "select") {
      const updatedOptions = mapValues(options, () => false);
      setOptions(updatedOptions);
    }
    else if ((option === null || option === void 0 ? void 0 : option.data) === "traversal") {
      setNodeSelection(Object.assign(Object.assign({}, nodeSelection), { isStartNodeSelected: true }));
      const updatedOptions = mapValues(options, () => false);
      setOptions(updatedOptions);
    }
    else if ((option === null || option === void 0 ? void 0 : option.data) === "pathfinding") {
      setNodeSelection(Object.assign(Object.assign({}, nodeSelection), { isStartNodeSelected: true, isEndNodeSelected: true }));
      const updatedOptions = mapValues(options, () => false);
      setOptions(updatedOptions);
    }
    setPullDownMenuState(false);
