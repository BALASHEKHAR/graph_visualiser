...
import { calculateAccurateCoords, findToNodeForTouchBasedDevices, } from "../../utility/calc";
import { Modal, TextField, MessageBar, MessageBarType } from "@fluentui/react";
import { bfs, dfs, dijkstra, minspantreeprims, } from "../../algorithms/algorithm";
...
export const Graph = (props) => {
  const { options, selectedEdge, selectedAlgo, visualizationSpeed, setVisualizingState, setNodeSelection, nodeSelection, isVisualizing, } = props;
  ...
  const resetNodesAndEdgesState = useCallback(() => {
    let updateNodes = nodes.map((node) => {
      return Object.assign(Object.assign({}, node), { isInShortestPath: false, isVisited: false });
    });
    let updatedEdges = cloneDeep(edges);
    updatedEdges.forEach((list, nodeId) => {
      let newList = list === null || list === void 0 ? void 0 : list.map((edge) => {
        return Object.assign(Object.assign({}, edge), { isUsedInTraversal: false, isUsedInShortestPath: false });
      });
  ...
  const deleteNode = (event) => {
    ...
    edges.forEach((list, nodeId) => {
      let newList = list === null || list === void 0 ? void 0 : list.filter((edge) => target.id !== edge.to);
  ...
  const visualizeSetState = (currentEdge, edgeAttribute, nodeAttribute) => {
    edges.forEach((list) => {
      list === null || list === void 0 ? void 0 : list.forEach((edge) => {
        var _a;
        ...
        if (edge.type === "undirected") {
          if (edge.from === currentEdge.from && edge.to === currentEdge.to) {
            edge[edgeAttribute] = true;
            (_a = edges.get(parseInt(currentEdge.to))) === null || _a === void 0 ? void 0 : _a.forEach((edge) => {
    ...
    for (let i = 0; i <= shortestPath.length; i++) {
      if (i === shortestPath.length) {
        setTimeout(() => {
          ...
          setNodeSelection(Object.assign(Object.assign({}, nodeSelection), { isStartNodeSelected: false, isEndNodeSelected: false }));
  ...
  const handleSelect = (event) => {
    ...
    else if ((selectedAlgo === null || selectedAlgo === void 0 ? void 0 : selectedAlgo.data) === "traversal" && isNode && !isVisualizing) {
      const startNodeId = parseInt(target.id);
      if ((selectedAlgo === null || selectedAlgo === void 0 ? void 0 : selectedAlgo.key) === "bfs") {
        let visitedEdges = bfs(edges, startNodeId);
        visualizeGraph(visitedEdges);
      }
      else if ((selectedAlgo === null || selectedAlgo === void 0 ? void 0 : selectedAlgo.key) === "dfs") {
    ...
    else if ((selectedAlgo === null || selectedAlgo === void 0 ? void 0 : selectedAlgo.data) === "pathfinding" &&
      isNode &&
      !isVisualizing) {
      if (!pathFindingNode) {
        ...
        setPathFindingNode(Object.assign(Object.assign({}, pathFindingNode), { endNodeId }));
        let output = dijkstra(edges, startNodeId, endNodeId);
        if ((output === null || output === void 0 ? void 0 : output.shortestPath.length) !== 0 && (output === null || output === void 0 ? void 0 : output.visitedEdges)) {
  ...
  const updateEdgeCoord = (x, y) => {
    var _a;
    let newBegEdgePositionsForNode = (_a = edges === null || edges === void 0 ? void 0 : edges.get(parseInt(currentNode.current.id))) === null || _a === void 0 ? void 0 : _a.map((edge) => {
      let { tempX, tempY } = calculateAccurateCoords(x, y, edge.nodeX2, edge.nodeY2);
      return Object.assign(Object.assign({}, edge), { x1: x, y1: y, x2: tempX, y2: tempY });
    });
    edges.set(parseInt(currentNode.current.id), newBegEdgePositionsForNode);
    edges.forEach((list, nodeId) => {
      let newList = list === null || list === void 0 ? void 0 : list.map((edge) => {
        if (currentNode.current.id === edge.to) {
          let { tempX, tempY } = calculateAccurateCoords(edge.x1, edge.y1, edge.nodeX2, edge.nodeY2);
          return Object.assign(Object.assign({}, edge), { x2: tempX, y2: tempY, nodeX2: x, nodeY2: y });
        }
        return edge;
      });
      edges.set(nodeId, newList);
  ...
  const addEdge = (id, tagName, x, y) => {
    ...
    if (currentEdge.current) {
      ...
      const isEdgeNotPresent = ((_a = edges === null || edges === void 0 ? void 0 : edges.get(parseInt(currentEdge.current.from))) === null || _a === void 0 ? void 0 : _a.length) !== 0
        ? (_b = edges === null || edges === void 0 ? void 0 : edges.get(parseInt(currentEdge.current.from))) === null || _b === void 0 ? void 0 : _b.every((edge) => edge.to !== currentEdge.current.to)
        : true;
      const isNotCurrentNode = currentEdge.current.from !== currentEdge.current.to;
      const isEdgePossible = isEdgeNotPresent && isNotCurrentNode;
      if (isEdgePossible) {
        if ((selectedEdge === null || selectedEdge === void 0 ? void 0 : selectedEdge.key) === "directed") {
          let { tempX: tempX2, tempY: tempY2 } = calculateAccurateCoords(x1, y1, x2, y2);
          ...
          (_c = edges === null || edges === void 0 ? void 0 : edges.get(fromNodeId)) === null || _c === void 0 ? void 0 : _c.push(toNode);
        }
        else if ((selectedEdge === null || selectedEdge === void 0 ? void 0 : selectedEdge.key) === "undirected") {
          const fromNodeId = parseInt(currentEdge.current.from);
          const toNodeId = parseInt(currentEdge.current.to);
          const isUndirectedEdgeNotPossible = ((_d = edges === null || edges === void 0 ? void 0 : edges.get(fromNodeId)) === null || _d === void 0 ? void 0 : _d.some((edge) => parseInt(edge.to) === toNodeId)) ||
            ((_e = edges === null || edges === void 0 ? void 0 : edges.get(toNodeId)) === null || _e === void 0 ? void 0 : _e.some((edge) => parseInt(edge.to) === fromNodeId));
          if (!isUndirectedEdgeNotPossible) {
            ...
            (_f = edges === null || edges === void 0 ? void 0 : edges.get(fromNodeId)) === null || _f === void 0 ? void 0 : _f.push(toNode);
            let { tempX: tempX1, tempY: tempY1 } = calculateAccurateCoords(x2, y2, x1, y1);
            let fromNode = {
              x1: x2,
              y1: y2,
              x2: tempX1,
            ...
            (_g = edges === null || edges === void 0 ? void 0 : edges.get(toNodeId)) === null || _g === void 0 ? void 0 : _g.push(fromNode);
          }
        }
        setEdges(edges);
      }
  ...
  const deleteEdge = (currentEdge, fromNode) => {
    ...
    if (currentEdge.type === "directed") {
      let upgradedEdges = (_a = edges === null || edges === void 0 ? void 0 : edges.get(fromNode)) === null || _a === void 0 ? void 0 : _a.filter((edge) => edge.to !== currentEdge.to);
      let newEdges = new Map(edges);
      newEdges.set(fromNode, upgradedEdges);
      setEdges(newEdges);
    }
    else if (currentEdge.type === "undirected") {
      let upgradedOutgoingEdges = (_b = edges === null || edges === void 0 ? void 0 : edges.get(fromNode)) === null || _b === void 0 ? void 0 : _b.filter((edge) => edge.to !== currentEdge.to);
      let upgradedIncomingEdges = (_c = edges === null || edges === void 0 ? void 0 : edges.get(parseInt(currentEdge.to))) === null || _c === void 0 ? void 0 : _c.filter((edge) => edge.to !== fromNode.toString());
      let newEdges = new Map(edges);
  ...
  const editEdgeWeight = () => {
    ...
    if ((edge === null || edge === void 0 ? void 0 : edge.type) === "directed") {
      let upgradedEdges = (_a = edges === null || edges === void 0 ? void 0 : edges.get(currentNode.current.id)) === null || _a === void 0 ? void 0 : _a.map((edge) => {
        if (edge.to === currentEdge.to) {
          return Object.assign(Object.assign({}, edge), { weight: currentEdge.weight });
        }
        return edge;
      });
      let newEdges = new Map(edges);
    ...
    else if ((edge === null || edge === void 0 ? void 0 : edge.type) === "undirected") {
      let upgradedOutgoingEdges = (_b = edges === null || edges === void 0 ? void 0 : edges.get(currentNode.current.id)) === null || _b === void 0 ? void 0 : _b.map((edge) => {
        if (edge.to === currentEdge.to) {
          return Object.assign(Object.assign({}, edge), { weight: currentEdge.weight });
        }
        return edge;
      });
      let upgradedIncomingEdges = (_c = edges === null || edges === void 0 ? void 0 : edges.get(parseInt(currentEdge.to))) === null || _c === void 0 ? void 0 : _c.map((edge) => {
  ...
  const handleMove = (event) => {
    ...
    let canDrawEdge = (selectedEdge === null || selectedEdge === void 0 ? void 0 : selectedEdge.key) &&
    ...
    if (canMoveNode) {
      ...
      const handleArrowEnd = (event) => {
        ...
        if (isTouchEvent) {
          const node = findToNodeForTouchBasedDevices(event.clientX - graph.current.getBoundingClientRect().left, event.clientY - graph.current.getBoundingClientRect().top, nodes);
          if (node) {
